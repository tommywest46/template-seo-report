 ...
 * Background: #080810, Primary: #7C3AFF, Accent: #00E5A0
 */
...
const metrics = [
  { label: "Keywords Tracked", value: 3, suffix: "", color: "#7C3AFF", glow: "rgba(124,58,255,0.4)" },
  { label: "Avg. Map Ranking", value: 20, suffix: "+", color: "#ef4444", glow: "rgba(239,68,68,0.4)" },
  { label: "Grid Points Analyzed", value: 156, suffix: "", color: "#eab308", glow: "rgba(234,179,8,0.4)" },
  { label: "Opportunity Score", value: 97, suffix: "%", color: "#00E5A0", glow: "rgba(0,229,160,0.4)" },
];
    ...
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{
          background: "linear-gradient(180deg, rgba(8,8,16,0.3) 0%, rgba(8,8,16,0.1) 40%, rgba(8,8,16,0.95) 100%)"
        }} />
        <div className="absolute inset-0" style={{
          background: "linear-gradient(90deg, rgba(8,8,16,0.6) 0%, transparent 60%)"
        }} />
        {/* Grid overlay */}
        <div className="absolute inset-0 grid-overlay opacity-30" />
        {/* Purple glow orb */}
        <div className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-15"
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-12 max-w-5xl">
          ...
          <div className={`flex items-center gap-3 flex-wrap transition-all duration-700 delay-300 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <button
              ...
              className="px-7 py-3.5 rounded-xl font-semibold text-sm text-white transition-all duration-200 hover:scale-105 hover:brightness-110"
              style={{
                background: "linear-gradient(135deg, #7C3AFF, #A855F7)",
                boxShadow: "0 0 24px rgba(124,58,255,0.45), 0 4px 12px rgba(0,0,0,0.3)",
            ...
            <button
              ...
              className="px-7 py-3.5 rounded-xl font-semibold text-sm border border-white/20 text-white/80 hover:border-white/40 hover:text-white transition-all duration-200 backdrop-blur-sm"
              style={{
        ...
        {/* Metrics bar */}
        <div className="border-t border-white/8" style={{ background: "rgba(8,8,16,0.85)", backdropFilter: "blur(12px)" }}>
