      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex items-center px-8 py-10">
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className={`transition-all duration-700 delay-100 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                <h1
                  ...
                  style={{ fontFamily: 'Outfit, sans-serif', fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: 800 }}
                >
            ...
            {/* ── Right column: primary heatmap image ── */}
            <div
              className={`relative transition-all duration-1000 delay-400 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
            >
              ...
              >
                ...
                <div className="relative">
                  <img
                    src={primaryHeatmap?.imageUrl}
                    alt={`${PROSPECT.name} heatmap — ${primaryHeatmap?.keyword}`}
                    className="w-full block"
                    style={{ maxHeight: "420px", objectFit: "cover", objectPosition: "center" }}
                  />
                  {/* Subtle bottom fade so it blends into the card */}
                  <div
